          ...
          <>
                      ...
                      <div className="mt-2">
                        <p
                          className={`whitespace-pre-line break-words text-sm leading-6 text-slate-600 ${
                            expandedDescriptions[photo.id] ? "" : "line-clamp-2"
                          }`}
                        >
                          {photo.description}
                        </p>
                        {photo.description.length > 120 && (
                          <button
                            ...
                            aria-expanded={Boolean(expandedDescriptions[photo.id])}
                          >
                            {expandedDescriptions[photo.id] ? "Show less" : "See more"}
                          </button>
                        )}
                      </div>
                    )}
            ...
            {hasMore && (
              <div className="mt-8 flex justify-center">
                <button
                  onClick={() => setDisplayCount((current) => current + 6)}
                  className="rounded-md bg-emerald-700 px-6 py-2 text-sm font-semibold text-white transition hover:bg-emerald-800"
                >
